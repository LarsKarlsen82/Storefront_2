// Import the fetchProductsByCategory function if it's defined in an external file
// Example: import { fetchProductsByCategory } from './path/to/your/file.js';
const basket = [];
...
export function categoriesCallBack(categories) {
